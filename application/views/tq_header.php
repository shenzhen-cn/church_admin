        ...
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <?php if (!empty($clas_p_p)) { ?>           
              <li class="treeview">
                ...
                <ul class="treeview-menu">              
                  <li><a href="<?php  echo base_url('priest_preach?id='."1"); ?>"><i class="fa fa-circle-o"></i>牧师课程</a></li>
                  <li><a href="<?php  echo base_url('uploadCourse'); ?>"><i class="fa fa-circle-o"></i>上传课程</a></li>
                  <li><a href="<?php  echo base_url('read_myEdit'); ?>"><i class="fa fa-circle-o"></i>在线阅读</a></li>
                  <li><a href="<?php  echo base_url('myEdit'); ?>"><i class="fa fa-circle-o"></i>编辑在线阅读</a></li>
                </ul>
              </li>
            <?php } ?>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                ...
                <li>
                  ...
                  <ul class="treeview-menu">
                    <li><a href="<?php  echo base_url('group/group_info'); ?>"><i class="fa fa-circle-o"></i> 小组修改</a></li>
                    <li><a href="<?php  echo base_url('group/addGroup'); ?>"><i class="fa fa-circle-o"></i> 添加小组</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li>
                  <a href="<?php  echo base_url('wall_for_photos'); ?>"><i class="fa fa-circle-o"></i> 照片墙</a>
                </li>                                                
              </ul>
            </li>
            ...
            <li>
             ...
             <li>
              ...
              <ul class="treeview-menu">  
                <li><a href="<?php echo base_url('addPersonal'); ?>"><i class="fa fa-circle-o"></i> 提交用户 </a></li>
                <li><a href="<?php echo base_url('user_registered'); ?>"><i class="fa fa-circle-o"></i> 注册状态 </a></li>
              </ul>
            </li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo base_url('homeSetting'); ?>"><i class="fa fa-circle-o"></i>   首页通知</a></li>
                <li><a href="<?php echo base_url('add_today_scriptures'); ?>"><i class="fa fa-circle-o"></i> 首页当日经文</a></li>
                <li><a href="<?php echo base_url('urgentPrayer'); ?>"><i class="fa fa-circle-o"></i> 首页紧急代祷</a></li>
                <li><a href="<?php echo base_url('noticeGroup'); ?>"><i class="fa fa-circle-o"></i> 各小组注意事项</a></li>
                <li><a href="<?php echo base_url('setPersonalData'); ?>"><i class="fa fa-circle-o"></i>个人资料设置</a></li>
